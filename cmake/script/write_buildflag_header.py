...
def GetOptions():
  ...
  parser.add_option('--prefix-header',
                     help="Append prefix to header_guard.")
  ...
  # add prefix
  prefix_header_guard = cmdline_options.prefix_header.upper()
  if prefix_header_guard and prefix_header_guard != "":
    header_guard = prefix_header_guard + '_' + header_guard
